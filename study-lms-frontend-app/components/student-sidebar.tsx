...
import { LayoutDashboard, BookOpen, Calendar, FileText, ClipboardList, LogOut, Menu, X } from "lucide-react"
...
const menuItems = [
  ...
  { href: "/student/lab-calendar", label: "Lab Events", icon: Calendar },
