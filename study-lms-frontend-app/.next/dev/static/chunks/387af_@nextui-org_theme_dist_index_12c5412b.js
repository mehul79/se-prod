...
"[project]/study-lms-frontend-app/node_modules/@nextui-org/theme/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
// src/utils/tv.ts
var import_tailwind_variants = __turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/tailwind-variants/dist/index.cjs [app-client] (ecmascript)");
...
var import_shared_utils = __turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/@nextui-org/theme/node_modules/@nextui-org/shared-utils/dist/index.js [app-client] (ecmascript)");
...
// src/utils/cn.ts
var import_clsx = __toESM(__turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/@nextui-org/theme/node_modules/clsx/dist/clsx.m.js [app-client] (ecmascript)"));
var import_tailwind_merge = __turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/tailwind-merge/dist/bundle-cjs.js [app-client] (ecmascript)");
...
var alert = tv({
    ...
    compoundVariants: [
        ...
        },
        {
            ...
            class: {
                base: [
                    colorVariants.bordered.default
                ],
                description: "text-default-600",
                closeButton: "text-default-400"
            }
        },
        {
            ...
            class: {
                base: [
                    colorVariants.bordered.primary
                ],
        ...
        },
        {
            ...
            class: {
                base: [
                    colorVariants.bordered.secondary
                ],
        ...
        },
        {
            ...
            class: {
                base: [
                    colorVariants.bordered.success
                ],
        ...
        },
        {
            ...
            class: {
                base: [
                    colorVariants.bordered.warning
                ],
...
var import_color2k = __turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/color2k/dist/index.exports.require.cjs.js [app-client] (ecmascript)");
// src/utils/object.ts
var import_flat = __toESM(__turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/flat/index.js [app-client] (ecmascript)"));
...
var flattenThemeObject = (obj)=>removeDefaultKeys((0, import_flat.default)(obj, {
        safe: true,
        delimiter: "-"
    }));
// src/colors/semantic.ts
...
// src/plugin.ts
var import_color = __toESM(__turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/color/index.js [app-client] (ecmascript)"));
var import_plugin = __toESM(__turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/tailwindcss/dist/plugin.js [app-client] (ecmascript)"));
var import_deepmerge = __toESM(__turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/deepmerge/dist/cjs.js [app-client] (ecmascript)"));
var import_shared_utils2 = __turbopack_context__.r("[project]/study-lms-frontend-app/node_modules/@nextui-org/theme/node_modules/@nextui-org/shared-utils/dist/index.js [app-client] (ecmascript)");
...
var corePlugin = (themes = {}, defaultTheme, prefix, addCommonColors)=>{
    ...
    return (0, import_plugin.default)(({ addBase, addUtilities, addVariant })=>{
        addBase({
            [":root, [data-theme]"]: {
                ...baseStyles(prefix)
            }
...
var nextui = (config = {})=>{
    ...
    let otherThemes = (0, import_shared_utils2.omit)(themeObject, [
        "light",
        "dark"
    ]) || {};
    Object.entries(otherThemes).forEach(([themeName, { extend, colors: colors2, layout }])=>{
        ...
        if (layout && typeof layout === "object") {
            otherThemes[themeName].layout = (0, import_deepmerge.default)(extend ? baseLayouts[extend] : defaultLayoutObj, layout);
        }
    });
    const light2 = {
...
//# sourceMappingURL=387af_%40nextui-org_theme_dist_index_12c5412b.js.map